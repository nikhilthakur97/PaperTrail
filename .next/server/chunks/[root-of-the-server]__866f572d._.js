...
"[project]/app/lib/azure-openai.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const client = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$azure$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AzureOpenAI"]({
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$database$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/database/schema.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$expressions$2f$conditions$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/drizzle-orm/sql/expressions/conditions.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$azure$2d$openai$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/lib/azure-openai.ts [app-route] (ecmascript)");
...
async function POST(req) {
    try {
        ...
        const systemPrompt = uploadedDocs.length > 0 ? 'You are a helpful research assistant. The user has uploaded research papers. Answer their questions based on the provided excerpts from these papers. Cite specific excerpts when relevant. Provide detailed, accurate responses in Markdown format. Use proper formatting including headers, lists, code blocks, and tables when appropriate.' : 'You are a helpful research assistant. You answer questions about research papers from PubMed and arXiv. Provide detailed, accurate responses in Markdown format. Use proper formatting including headers, lists, code blocks, and tables when appropriate.';
        const chatMessages = [
            {
                role: 'system',
            ...
            ...conversationHistory.map((msg)=>({
                    role: msg.role,
                    content: msg.role === 'user' && msg.content === message && contextFromDocuments ? msg.content + contextFromDocuments : msg.content
                }))
        ];
        ...
        const stream = new ReadableStream({
            async start (controller) {
                try {
                    // Get streaming completion from Azure OpenAI
                    const streamingResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$azure$2d$openai$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].chat.completions.create({
                        model: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$azure$2d$openai$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deployment"],
...
//# sourceMappingURL=%5Broot-of-the-server%5D__866f572d._.js.map